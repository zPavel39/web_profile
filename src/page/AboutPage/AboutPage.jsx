		...
		<div className='about'>
			...
			<div className='about__list'>
				...
				<p className='about__list_info'>
					...
					подобие rkeepera и iiko. Работаю в команде из 6 человек. Реализовал
					...
					<ul className='about__listInfo'>
						...
						<li className='about__listInfo_item'>
							по управлению филиалами/брэндами/мультибрэндами
						</li>
						<li className='about__listInfo_item'>
				...
				<p className='about__list_info'>
					...
					Vue) компонентов, работа со стэйт менеджерами, API, рефакторинг и
